...
import { GoalIcon } from "@/components/MatchEventIcons";
...
export function GoalItem({
  ...
  return (
    <li>
      <RecentEventHighlight createdAt={goal.createdAt} className="rounded-lg border p-1.5">
        <div className="flex items-center gap-2 text-sm">
          <span className="w-10 shrink-0 text-right font-mono text-zinc-500">
            {goal.minute !== null ? `${goal.minute}'` : ""}
          </span>
          <GoalIcon className="h-4 w-4 shrink-0 text-accent" />
