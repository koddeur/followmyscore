...
export function SubstitutionItem({
  ...
  return (
    <li className="flex items-center gap-2 text-sm">
      ...
      {substitution.playerInNumber !== null && <span className="text-zinc-500">#{substitution.playerInNumber}</span>}
      {(substitution.playerOutName || substitution.playerOutNumber !== null) && (
        <span className="text-zinc-500">
          ...
          {substitution.playerOutName && substitution.playerOutNumber !== null && ` #${substitution.playerOutNumber}`}
        </span>
      )}
